  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50 to-cyan-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mt-20 mb-10 max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center md:items-stretch gap-12">
            <div className="flex-1 flex flex-col justify-center text-left text-gray-800">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-2 mb-6 text-base">
                <div className="flex items-center gap-2"><span className="inline-block w-2 h-2 bg-blue-400 rounded-full"></span>Lifestyle</div>
                <div className="flex items-center gap-2"><span className="inline-block w-2 h-2 bg-blue-400 rounded-full"></span>Hospitality</div>
                <div className="flex items-center gap-2"><span className="inline-block w-2 h-2 bg-blue-400 rounded-full"></span>Industrial Manufacturing</div>
            ...
            <div className="flex-1 flex justify-center items-center">
              <Image src="/20943566.png" alt="Global Impact" width={480} height={320} className="drop-shadow-lg rounded-xl object-cover w-full max-w-[480px] h-auto" />
            </div>
          </div>
        </section>
      </div>
